...
namespace TacoTuesday.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            // Attempt all the code inside the block (between {}) and if
            // there is an EXCEPTION, don't crash the program, go do the "catch" block
            try
            {
            ...
            {
                // Make a custom error response, in the same structure as dotnet errors
                var response = new
                {
                    status = 400,
